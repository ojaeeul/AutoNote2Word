...
with open('/Volumes/HDD_Uti/AutoNote2Word_Windows/app.py', 'r', encoding='utf-8') as f:
    content = f.read()
...
pattern = r"def load_local_academic_db\(\):.*?(?=def open_in_new_window\()"
new_content = re.sub(pattern, new_func + "\n\n", content, flags=re.DOTALL)

with open('/Volumes/HDD_Uti/AutoNote2Word_Windows/app.py', 'w', encoding='utf-8') as f:
    f.write(new_content)
